...
public class AppOrderPositivTest {
    ...
    public void successForm() {
        driver.findElement(By.cssSelector("[data-test-id='name'] input")).sendKeys("Белая Светлана");
        driver.findElement(By.cssSelector("[data-test-id='phone'] input")).sendKeys("+79898976542");
